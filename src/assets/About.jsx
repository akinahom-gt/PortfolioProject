...
const about = () => {
  return (
    <div className="text-white px-4  ">
      ...
      <h2 id="#About" className="py-6 text-gray-500 lg:w-[550px] h-[500px]">
        ...
        corporation, and a digital product studio.<br></br> <br></br>My main focus these days is
        building accessible user interfaces for our customers at Klaviyo. I most
        ...
        everything you need to know to build a web app with the Spotify API.<br></br><br></br>
